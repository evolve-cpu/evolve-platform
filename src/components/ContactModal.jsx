...
// // import { hand_with_thunder, hand_with_thunder_mobile } from "../assets/images/Home";
...
//         >
//           <img
//             src={isCloseHovering ? cross_line_pink1 : cross_line_black}
//             alt="close"
//             className="w-6 h-6 md:w-8 md:h-8 pointer-events-none select-none transition-all"
//           />
//         </button>
//         {/* Scrollable Content */}
//         <div className="overflow-y-auto max-h-[90vh] scrollbar-thin scrollbar-thumb-black scrollbar-track-transparent">
...
//             {/* ================= RIGHT SECTION (image) ================= */}
//             {/* ================= RIGHT SECTION (image) ================= */}
//             <div className="relative w-full md:w-1/2 flex justify-end items-end min-h-[200px] overflow-hidden">
//               {/* Desktop image */}
//               <img
//                 src={hand_with_thunder}
//                 alt="hand with thunder"
//                 className="hidden md:block pointer-events-none select-none absolute -right-0 -bottom-20 w-[120%] max-w-none object-contain"
//               />
//               {/* Mobile image */}
//               <img
//                 src={hand_with_thunder_mobile}
//                 alt="hand with thunder"
//                 className="md:hidden pointer-events-none select-none absolute right-0 bottom-0 w-[65%] object-contain"
//               />
//             </div>
//           </div>
//         </div>
...
//   // Enhanced scroll prevention - prevents background scroll when modal is open
//   useEffect(() => {
//     if (isOpen) {
...
//       // Also lock html element to ensure no scrolling on any device
...
const ContactModal = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      // Lock scroll without fixed positioning to avoid visual jump
      document.body.style.overflow = "hidden";
