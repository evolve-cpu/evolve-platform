...
const AuthModal = ({ isOpen, onClose, user }) => {
  ...
  const modal = (
    <>
      ...
      {/* card */}
      <div className="fixed z-[9991] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[92vw] max-w-[460px] bg-evolve-yellow border-2 border-black rounded-2xl px-7 py-8 shadow-[8px_8px_0px_rgba(0,0,0,0.25)]">
        {/* close */}
        <button
          onClick={onClose}
        ...
        {step === 1 ? (
          <>
            ...
            <form onSubmit={handleSendOtp} className="mt-6 flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  required
                  className="w-full border-2 border-black rounded-lg bg-white text-black px-4 py-3 text-[16px] outline-none focus:ring-2 focus:ring-black placeholder:text-gray-400"
                />
              </div>
              ...
              {error && (
                <p className="text-red-600 text-[13px] font-normal">{error}</p>
              )}

              <button
                type="submit"
                disabled={loading}
                className="w-full bg-black text-evolve-yellow font-extrabold text-[18px] rounded-lg py-3 flex items-center justify-center gap-2 transition-opacity duration-150 disabled:opacity-50"
              >
                {loading ? (
                  <>
            ...
            <div className="flex items-center gap-3 my-5">
              ...
              <span className="text-black/50 text-[13px]">or</span>
              <div className="flex-1 h-[1px] bg-black/30" />
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-white text-black border-2 border-black font-semibold text-[16px] rounded-lg py-3 flex items-center justify-center gap-3 transition-opacity duration-150 disabled:opacity-50"
            >
              {/* Google "G" logo */}
              <svg
                width="20"
          ...
          <>
            ...
            <button
              ...
              className="flex items-center gap-1 text-black/60 text-[13px] font-normal mb-5 hover:text-black transition-colors"
            >
              ← Back
            </button>
            ...
            >
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  autoFocus
                  className="w-full border-2 border-black rounded-lg bg-white text-black text-center px-4 py-4 text-[28px] font-extrabold tracking-[0.4em] outline-none focus:ring-2 focus:ring-black placeholder:text-gray-300 placeholder:tracking-normal placeholder:text-[18px] placeholder:font-normal"
                />
              </div>
