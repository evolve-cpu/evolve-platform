...
// // TODO: Import your assets here
// // import { asset1, asset2, asset3 } from "../../assets/images/Home";

// // Step labels for this scene - these will be used for snap points
// export const SCENE_NEW_STEP_LABELS = [
//   "scene_new_step0_intro",
//   "scene_new_step1_first_animation",
//   "scene_new_step2_second_animation"
//   // Add more step labels as needed
// ];

// // Timeline hook for SceneNew animation - works with master timeline
...
//   // Add your second step label
//   tl.addLabel("scene_new_step1_first_animation", 1.0);
...
//   // Add your third step label
//   tl.addLabel("scene_new_step2_second_animation", 2.0);

//   // Clear will-change at the end for performance
//   tl.set(refs.container, { willChange: "auto" }, "+=0.5");
...
//   // Add more refs as needed for your elements
...
//     // Expose more refs as needed
//     // element1: element1Ref.current,
//     // element2: element2Ref.current,
//   }));
...
//     >
//       {/* Background */}
//       <div className="absolute inset-0 w-full h-full bg-gradient-to-b from-purple-900 to-blue-900 z-[1]">
//         {/* TODO: Replace with your background image/color */}
//       </div>
...
//             New Scene Template
//           </h1>
//           <p className="text-xl md:text-2xl">Replace this with your content</p>
//         </div>
//       </div>
...
//         style={{
//           // Add your positioning and styling
//         }}
//       />
//       */}
//     </section>
...
// // Import your assets - UPDATE THESE PATHS
// import {
//   // rays_webinars,
//   vector,
//   vector_mobile,
...
//   // ========== STEP 2: Vector & Thunders Move Down, Circle Appears (ALL PARTS) ==========
//   tl.addLabel("scene_new_step2_circle_appears", 3.7);

//   // Move vector + thunders
//   tl.to(
//     refs.vector,
//     {
...
//   tl.addLabel("scene_new_step5_outer_rotating", 10.0);

//   // Outer circle rotation happens in component useEffect
//   // This is just a marker for the step
...
//       {/* Combined Circle Container - appears in center of vector */}
//       <div
...
//       <img
//         ref={vectorRef}
//         src={isMobile ? vector_mobile : vector_1st}
//         alt="vector"
//         className="absolute left-0 w-full z-[3]"
//         style={{
//           bottom: 0,
...
//       {/* Combined Circle Container - appears at the center/intersection of the V vector */}
//       <div
//         ref={combinedCircleContainerRef}
//         className="absolute left-1/2 -translate-x-1/2 z-[15] pointer-events-none"
//         style={{
...
//   // Container scale - appears after crossfade
//   tl.to(
//     refs.combinedCircleContainer,
//     {
//       opacity: 1,
...
//       <img
//         ref={vector2ndRef}
//         src={isMobile ? vector_mobile : vector_2nd}
//         alt="vector second"
//         className="absolute left-0 w-full z-[3]"
//         style={{
//           bottom: 0,
...
//   "scene_new_step7_toolkit_text_appears", // "the evolve toolkit" text
//   "scene_new_step8_mini_ovals_appear", // Mini ovals appear
//   "scene_new_step9_full_ovals_transform", // Mini ovals transform to full
//   "scene_new_step10_cards_interactive" // Final interactive state
// ];
...
//   // Short pause on clean yellow background
//   tl.to({}, { duration: 0.5 });

//   // ========== STEP 7: TOOLKIT TEXT APPEARS ==========
//   const toolkitStart = exitStart + 2.5;
//   tl.addLabel("scene_new_step7_toolkit_text_appears", toolkitStart);
...
//   // ========== STEP 8: MINI OVALS APPEAR ==========
//   const miniovalsStart = toolkitStart + 2.0;
//   tl.addLabel("scene_new_step8_mini_ovals_appear", miniovalsStart);

//   // Mini ovals appear with stagger
//   tl.to(
//     refs.ovalMini3,
//     {
//       opacity: 1,
...
//   // ========== STEP 9: TRANSFORM TO FULL OVALS ==========
//   const transformStart = miniovalsStart + 2.0;
//   tl.addLabel("scene_new_step9_full_ovals_transform", transformStart);

//   if (isMobile) {
//     // Mobile: Vertical stacking - transform in place

//     // Direct crossfade from mini to full
//     tl.to(
...
//     );
//   } else {
//     // Desktop: Horizontal layout with spread effect

//     // Mini ovals scale up and spread
//     tl.to(
//       refs.ovalMini3, // Left
//       {
//         scale: 1.2,
...
//   // ========== STEP 10: CARDS BECOME INTERACTIVE ==========
//   const interactiveStart = transformStart + 2.0;
//   tl.addLabel("scene_new_step10_cards_interactive", interactiveStart);

//   // Enable pointer events on cards
//   if (refs.oval1 && refs.oval2 && refs.oval3) {
//     tl.call(
//       () => {
//         if (refs.oval1) refs.oval1.style.pointerEvents = "auto";
//         if (refs.oval2) refs.oval2.style.pointerEvents = "auto";
//         if (refs.oval3) refs.oval3.style.pointerEvents = "auto";
//       },
//       null,
//       interactiveStart
//     );
...
//   const cardLinks = {
//     1: "/toolkit/card-1", // Right card
//     2: "/toolkit/card-2", // Center card
//     3: "/toolkit/card-3" // Left card
//   };
...
// // Step labels for this scene - UPDATED: Removed intermediate steps
// export const SCENE_NEW_STEP_LABELS = [
//   "scene_new_step0_intro", // Initial state - all elements visible
//   "scene_new_step1_text_appears", // Text fades in
//   "scene_new_step2_circle_appears", // Vector moves down, circle appears
...
//   "scene_new_step8_cards_interactive" // Final interactive state (was step 10)
// ];
...
//   // FIX 1: Combined circle outer part exits WITH ROTATION
//   if (refs.combinedCircle?.outer) {
//     tl.to(
//       refs.combinedCircle.outer,
//       {
//         y: "50vh",
//         opacity: 0,
//         rotation: "-=360", // Continue rotating while exiting
//         duration: 1.0,
//         ease: "power2.in"
//       },
//       exitStart
...
//   // FIX 2: REMOVED - No pause on clean background
//   // FIX 2: REMOVED - No separate text appearance step
//   // Toolkit section starts IMMEDIATELY after exit completes

//   // ========== STEP 7: TOOLKIT CARDS APPEAR (Combined step) ==========
//   const toolkitStart = exitStart + 1.2; // Start right after exit
//   tl.addLabel("scene_new_step7_toolkit_cards_appear", toolkitStart + 2);

//   // Text and mini ovals appear together
//   tl.to(
//     refs.text8,
//     {
//       opacity: 1,
...
//   // Transform to full ovals (happens quickly after mini appear)
//   const transformStart = toolkitStart + 1.2;

//   if (isMobile) {
//     // Mobile: Direct crossfade
//     tl.to(
//       [refs.ovalMini1, refs.ovalMini2, refs.ovalMini3],
//       {
//         opacity: 0,
...
//   // ========== STEP 8: CARDS BECOME INTERACTIVE ==========
//   const interactiveStart = transformStart + 1.8;
//   tl.addLabel("scene_new_step8_cards_interactive", interactiveStart);

//   // Enable pointer events on cards
//   tl.call(
//     () => {
//       // enable container first
//       if (refs.fullOvalsContainer) {
//         refs.fullOvalsContainer.style.pointerEvents = "auto";
//       }
//       if (refs.oval1) refs.oval1.style.pointerEvents = "auto";
//       if (refs.oval2) refs.oval2.style.pointerEvents = "auto";
//       if (refs.oval3) refs.oval3.style.pointerEvents = "auto";
...
//       {/* FIX 3: Full Ovals Container - Interactive Cards with proper parent pointer-events */}
//       {/* FIX: Full Ovals Container - Enable pointer events immediately when visible */}
//       <div
...
//             height: "auto",
//             opacity: 0,
//             pointerEvents: "auto" // CHANGED FROM "auto"
//           }}
//         />
//       </div>
//     </section>
...
//     {
//       opacity: 1,
//       scale: isMobile ? 0.8 : 0.8, // CHANGED: 0.8 instead of 0.5 for mobile
//       duration: 1.2,
//       ease: "back.out(1.5)"
//     },
//     4.7
...
//         className="absolute left-1/2 -translate-x-1/2 z-[15] pointer-events-none"
//         style={{
//           width: isMobile ? "70vw" : "40vw", // CHANGED: 70vw instead of 60vw
//           height: isMobile ? "70vw" : "40vw", // CHANGED: 70vw instead of 60vw
//           bottom: isMobile ? "20%" : "-15%", // CHANGED: 20% instead of 30% - positioned at V intersection
//           opacity: 0
//         }}
//       >
//         <CombinedCircle ref={combinedCircleRef} isMobile={isMobile} />
...
//       {
//         opacity: 1,
//         top: "50%", // CHANGED: Center position
//         transform: "translate(-50%, -50%)", // CHANGED: Proper centering
//         scale: 1
//       },
//       step11Start
//     );
...
//       refs.oval1,
//       {
//         top: `${100 + scrollContainerHeight * 0.6}vh`, // CHANGED: Scroll further down
//         scale: 0.9,
//         opacity: 0,
//         duration: 2.8,
//         ease: "power3.inOut"
...
//               position: "absolute",
//               left: "50%",
//               top: "50%", // CHANGED: 50% to center cards in middle of screen
//               transform: "translate(-50%, -50%)", // CHANGED: -50% on Y axis to properly center
//               width: "85vw",
//               maxWidth: "380px"
//             }}
//           >
