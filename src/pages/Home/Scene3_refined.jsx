...
// ─── Scene3_refined ───────────────────────────────────────────────────────────
const Scene3_refined = React.forwardRef(({ isMobile = false, isActive = false }, ref) => {
      ...
      >
          ...
          {CARDS.map((_, i) => (
            <button
              ...
              style={{
                ...
                background: i === currentCard ? "rgba(163,91,251,1)" : "transparent",
                padding: 0,
                cursor: "pointer",
                transition: "all 0.2s",
                flexShrink: 0
        ...
        <button
          ...
          style={{
            background: "none",
            border: "none",
            color: currentCard === CARDS.length - 1 ? "rgba(0,0,0,0.3)" : "#000",
            fontSize: "1.6rem",
            fontWeight: 700,
