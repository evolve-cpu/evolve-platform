...
const GOOGLE_ICON = (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
    <path
      d="M19.6 10.23c0-.68-.06-1.36-.18-2H10v3.79h5.4a4.62 4.62 0 0 1-2 3.03v2.52h3.23C18.4 16 19.6 13.32 19.6 10.23Z"
      fill="#4285F4"
    />
    <path
      d="M10 20c2.7 0 4.97-.9 6.63-2.43l-3.23-2.52c-.9.6-2.04.96-3.4.96-2.61 0-4.82-1.76-5.61-4.13H1.07v2.6A10 10 0 0 0 10 20Z"
      fill="#34A853"
    />
    <path
      d="M4.39 11.88A6.01 6.01 0 0 1 4.07 10c0-.65.11-1.28.31-1.88V5.52H1.07A10 10 0 0 0 0 10c0 1.61.38 3.13 1.07 4.48l3.32-2.6Z"
      fill="#FBBC05"
    />
    <path
      d="M10 3.96c1.47 0 2.8.5 3.84 1.5l2.87-2.87A9.94 9.94 0 0 0 10 0 10 10 0 0 0 1.07 5.52l3.32 2.6C5.18 5.72 7.39 3.96 10 3.96Z"
      fill="#EA4335"
    />
  </svg>
);
  ...
  return (
    <div className="flex flex-col items-center justify-center flex-1 gap-8 px-6">
      ...
      <div className="w-full max-w-xs space-y-4 text-center">
        <p className="text-evolve-yellow font-semibold text-base md:text-lg">
          {label}
        </p>
        <p className="text-white text-sm md:text-base">{sub}</p>
        <div className="w-full h-1 rounded-full bg-white/20 overflow-hidden">
          <div
            className="h-full rounded-full bg-evolve-yellow transition-all duration-300"
...
export default function SignIn() {
  ...
  const inputCls =
    "w-full border border-white/15 rounded-2xl px-5 py-4 text-white placeholder-white/30 text-base outline-none focus:border-evolve-yellow/60 transition-colors";
            ...
            <div className="w-full max-w-sm md:max-w-md mx-auto flex flex-col gap-5">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-white/40 text-sm mt-3">
                  join designers, institutions and corporates who are shaping
              ...
              >
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                  <path
                    d="M1.5 4.5A1.5 1.5 0 0 1 3 3h12a1.5 1.5 0 0 1 1.5 1.5v9A1.5 1.5 0 0 1 15 15H3A1.5 1.5 0 0 1 1.5 13.5v-9Z"
                    stroke="white"
                    strokeWidth="1.3"
                  />
                  <path
                    d="M1.5 4.5 9 9.75 16.5 4.5"
                    stroke="white"
                    strokeWidth="1.3"
                    strokeLinecap="round"
                  />
              ...
              <p className="text-white/25 text-xs text-center">
                by continuing, you agree to evolve's terms &amp; conditions and
                privacy policy.
              </p>
            </div>
          </div>
