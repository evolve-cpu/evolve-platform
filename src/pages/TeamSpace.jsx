            ...
            <div className="flex flex-col gap-4">
              {isOwner && (
                <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 flex flex-col gap-3">
                  <p className="text-white/30 text-[10px] font-bold uppercase tracking-wide">invite someone</p>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder={isInstitute ? `their@email.com — as ${inviteRole}` : "their@email.com"}
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 flex flex-col gap-1">
                <p className="text-white/30 text-[10px] font-bold uppercase tracking-wide mb-3">
                  {isInstitute ? "faculty & students" : "team"}
                </p>
                {members.length === 0 && (
                  <p className="text-white/25 text-sm italic">
                    no members yet — invite {isInstitute ? "faculty & staff" : "your team"} to fill this space with
