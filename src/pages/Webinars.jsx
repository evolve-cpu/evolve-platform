...
//     year: d.toLocaleDateString("en-IN", { timeZone: "Asia/Kolkata", year: "numeric" }),
//     time: d.toLocaleTimeString("en-IN", { timeZone: "Asia/Kolkata", hour: "numeric", minute: "2-digit", hour12: true })
//   };
// }
...
//   return (
//     <section className="relative bg-evolve-pink py-14 px-6 md:px-16">
//       <h2 className="text-white text-center font-extrabold text-2xl md:text-3xl mb-8">
//         Upcoming Event
//       </h2>

//       <div className="relative max-w-4xl mx-auto flex items-center gap-3 md:gap-6">
//         {events.length > 1 && (
//           <button
...
//         <div className="flex-1 bg-evolve-yellow rounded-[32px] md:rounded-[48px] border-2 border-black p-6 md:p-10 flex flex-col md:flex-row items-center gap-6 overflow-hidden">
...
//             </span>
//             <h3 className="text-evolve-pink font-extrabold text-2xl md:text-3xl leading-tight">
//               {event.title}
//             </h3>
//             {event.speaker_name && (
//               <p className="text-black font-semibold mt-2">by {event.speaker_name}</p>
//             )}
//             <div className="flex items-center gap-4 mt-4">
//               <p className="text-evolve-pink font-extrabold">
//                 {month} {day}
//                 <span className="block text-black font-normal text-xs">{new Date(event.start_time).getFullYear()}</span>
//               </p>
//               <div className="w-px h-8 bg-black/20" />
//               <p className="text-evolve-pink font-extrabold">
//                 {time}
//                 <span className="block text-black font-normal text-xs">IST</span>
//               </p>
//             </div>
//             <Link
//               to={`/events/${event.slug}`}
//               className="inline-flex items-center gap-2 mt-5 bg-black text-white font-bold text-sm px-5 py-3 rounded-full"
//             >
//               Register now →
//             </Link>
//           </div>
//           {(event.speaker_photo_url || event.cover_image_url) && (
//             <img
//               src={event.speaker_photo_url || event.cover_image_url}
//               alt={event.speaker_name || event.title}
//               className="w-32 h-32 md:w-44 md:h-44 rounded-2xl object-cover flex-shrink-0"
//             />
//           )}
//         </div>
