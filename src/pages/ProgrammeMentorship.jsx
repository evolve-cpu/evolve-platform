...
export default function ProgrammeMentorship() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#161618" }}>
      ...
      <div className="max-w-3xl mx-auto px-6 md:px-8 py-10 flex flex-col gap-14">
        {/* hero */}
        <div>
          ...
          <div className="flex flex-wrap gap-2 mt-5">
            {["1:1 personalised", "4 stages", "5 sessions"].map((c) => (
              <span key={c} className="text-xs font-semibold px-3.5 py-1.5 rounded-full border border-white/10 bg-white/[0.04] text-white/70">
                {c}
              </span>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="rounded-2xl border border-white/10 overflow-hidden flex flex-col sm:flex-row">
            <div className="sm:w-[220px] flex-shrink-0 bg-white/[0.03]">
        ...
        {/* framework */}
        <div>
          <h2 className="text-white font-bold text-xl mb-4">our framework</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {FRAMEWORK.map((s, i) => (
              <div key={s.title} className="rounded-2xl border border-white/10 bg-white/[0.03] px-5 py-4">
                <p className="text-evolve-yellow font-bold text-sm">
                  {i + 1}. {s.title}
                </p>
                <p className="text-white/40 text-sm mt-1.5 leading-relaxed">{s.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* sticky enrol bar */}
      <div className="sticky bottom-0 border-t border-white/10 bg-[#1c1c1f]/95 backdrop-blur px-6 md:px-8 py-4 flex items-center justify-between gap-4">
        <div>
